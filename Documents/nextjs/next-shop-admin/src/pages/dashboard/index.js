...
export default function Dashboard() {
  ...
  ////////////// FIn Llamada al paginador /////////////////

  ////////////// Llamando al chart /////////////////
  const categoryNames = products?.map((product) => product.category); // Accedemos a todas las categorias que se tienen
  ...
  const data = {
    datasets: [
      {
        // Nos ayudara a mostrar informacion de donde la tengamos ya sea desde una API, OBJETO, etc
        label: 'Category',
