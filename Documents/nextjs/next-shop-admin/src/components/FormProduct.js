...
export default function FormProduct({ setOpen, setAlert, product }) {
  ...
  const handleSubmit = (event) => {
    ...
    const data = {
      title: formData.get('title'), // 'title' = ya que tiene un htmlfor y un id con el nombre title (es importante para q no tengas warning que el htmfor el name y el id deban tene rel mismo nobre)
      price: parseInt(formData.get('price')), // Ya que el precio es un valor numero, lo transofrmamos a string para poder capturarlo
