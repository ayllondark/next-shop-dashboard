...
export default function Header() {
  const varauth = useAuth();
  const userData = {
    name: varauth?.user?.name,
    email: varauth?.user?.email,
    imageUrl: `https://ui-avatars.com/api/?name=${varauth.user?.name}&background=0D8ABC&color=fff`,
  };
              ...
              <div className="flex items-center justify-between h-16">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <Image className="h-8 w-8" src="https://tailwindui.com/img/logos/workflow-mark-indigo-500.svg" width={50} height={50} alt="Workflow" />
                  </div>
                    ...
                    <Menu as="div" className="ml-3 relative">
                      <div>
                        <Menu.Button className="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                          ...
                          <Image className="h-8 w-8 rounded-full" src={userData.imageUrl} alt="" width={50} height={50} />
                        </Menu.Button>
                      </div>
                      <Transition
                        as={Fragment}
                      ...
                      >
                        ...
                        <button onClick={() => varauth.logout()} className='block px-4 py-2 text-sm text-gray-700'>
                                  Logout
                                </button>
                        </Menu.Items>
                      </Transition>
            ...
            <Disclosure.Panel className="md:hidden">
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                <div className="flex items-center px-5">
                  <div className="flex-shrink-0">
                    <Image className="h-10 w-10 rounded-full" src={userData.imageUrl} width={'100%'} height={'100%'} alt="" />
                  </div>
                  <div className="ml-3">
